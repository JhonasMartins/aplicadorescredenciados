...
class AndamentoWidget extends StatefulWidget {
  const AndamentoWidget({Key key}) : super(key: key);

  @override
  _AndamentoWidgetState createState() => _AndamentoWidgetState();
}

class _AndamentoWidgetState extends State<AndamentoWidget> {
